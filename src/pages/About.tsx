        ...
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-muted-foreground text-lg mb-4">
              MUMBSO was founded by passionate Medical Biotechnology students at Maseno University who recognized the need for a dedicated organization to support students in this unique program that combines medical biotechnology with information technology.
            </p>
            <p className="text-muted-foreground text-lg mb-4">
