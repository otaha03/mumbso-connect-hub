          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                The Maseno University Medical Biotechnology Students Organization (MUMBSO) is the official student-run organization for students pursuing Medical Biotechnology with Information Technology.
              </p>
